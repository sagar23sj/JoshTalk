...
var file_sample_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x22, 0x84, 0x02, 0x0a, 0x0a, 0x42, 0x65, 0x6e, 0x63, 0x68,
	0x4c, 0x61, 0x72, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	...
	0x04, 0x64, 0x65, 0x73, 0x63, 0x12, 0x1a, 0x0a, 0x08, 0x6e, 0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d,
	...
	,
...
var file_sample_proto_goTypes = []interface{}{
	(*BenchLarge)(nil), // 0: sample.BenchLarge
	(*Response)(nil),   // 1: sample.Response
}
var file_sample_proto_depIdxs = []int32{
	0, // 0: sample.SampleService.Hello:input_type -> sample.BenchLarge
	1, // 1: sample.SampleService.Hello:output_type -> sample.Response
...
type SampleServiceClient interface {
	Hello(ctx context.Context, in *BenchLarge, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *sampleServiceClient) Hello(ctx context.Context, in *BenchLarge, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/sample.SampleService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SampleServiceServer interface {
	Hello(context.Context, *BenchLarge) (*Response, error)
}
...
func (*UnimplementedSampleServiceServer) Hello(context.Context, *BenchLarge) (*Response, error) {
...
func _SampleService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sample.SampleService/Hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServiceServer).Hello(ctx, req.(*BenchLarge))
	}
